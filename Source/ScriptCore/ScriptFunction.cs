namespace ScriptCore
{
    ...
    public class ScriptFunction
    {
        ...
        /// <summary>
        /// Only set this inside user script runners
        /// </summary>
        ...
        /// <summary>
        /// Returns an IEnumerator with a copy of this ScriptFunction that yield returns null every frame. If it is a normal function it will call once and yield break.<para/>
        ...
        public IEnumerator AsUnityCoroutine(params object[] args)
        {
            ...
            //var hook = new ScriptFunction(this) { AutoResetCoroutine = false };
            //var co = hook.Coroutine.Coroutine;

            //while (state != CoroutineState.Dead)
            //{
            //    state = hook.RunAsUnityCoroutine(co, null, args);
            //    yield return null;
            //}
            ...
            {
                CoroutineState state = CoroutineState.NotStarted;
                var func = new ScriptFunction(this);// { AutoResetCoroutine = false };
